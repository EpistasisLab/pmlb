...
If you do use it, please share a publicly accessible link to your Google Colab notebook in the pull request when you submit one.
...
- If you contributed a new dataset:
  ...
  - GA adds the dataset name to `dataset_with_metadata`, which contains the names of datasets with customized metadata files, and push back these changes to your branch as long as it's not master.

- If you wished to regenerate all the pandas profiling reports:
  - Please include `[regenerate_profiles]` in the commit message.

- If you wished to regenerate/update supporting files for all datasets including :
